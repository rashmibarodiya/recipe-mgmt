export default function LandingPage() {
    ...
    return (
        ...
        <div className="flex items-center min-h-full bg-peach bg-cover bg-center">
            <div className="flex justify-center w-full h-full md:w-3/4 lg:w-full h-screen p-20 pt-40 bg-red-100 shadow-lg text-slate-100">
                {/* Outer red container */}
                <div className="flex justify-center w-1/2 h-full md:w-1/2 lg:w-1/2 h-[500px] p-20 bg-red-400 shadow-lg text-slate-100">
